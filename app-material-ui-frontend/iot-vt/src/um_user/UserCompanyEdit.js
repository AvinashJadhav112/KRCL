...
function UserCompanyEdit() {
  ...
  const validationSchema = Yup.object().shape({
    ...
    company_name_dialog: Yup.string()
      .required(' Company Name is required')
      .matches(/^[aA-zZ\s]+$/, 'Only alphabets are allowed for this field '),

    role_dialog: Yup.string()
        ...
        <div className="card-body">
          <div className="form-row">
            ...
            <div className="form-group col-4">
              ...
              <input name="company_name_dialog" type="string" ref={register} className={`form-control ${errors.company_name_dialog ? 'is-invalid' : ''}`} />
              <div className="invalid-feedback">{errors.company_name_dialog?.message}</div>
            </div>
            ...
            <div className="form-group col-4">
              ...
              <input name="role_dialog" type="string" ref={register} className={`form-control ${errors.role_dialog ? 'is-invalid' : ''}`} />
              <div className="invalid-feedback">{errors.role_dialog?.message}</div>
            </div>

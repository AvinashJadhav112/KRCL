...
class SummaryKRCL extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
                      ...
                      {this.state.displayindicator.map((sd) => (
                        ...
                        <Box
                          ...
                          style={{
                            ...
                            backgroundColor: currentdate.getDate() == sd.timestamp.substring(8, 10) ? sd.timestamp.substring(14, 16) >= currentdate.getMinutes() - 5 ? 'green' : 'red' : 'red',
              ...
              >
                {di.data.latestSensorData.map((readings, i) => (
                  ...
                  (() => {
                    ...
                    return (
                      console.log(Math.round(readings.rawValue)),
                      console.log(readings.max),
                        <div
                          key={i + 1}
                          style={{
                            display: 'flex',
